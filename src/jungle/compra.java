...
public class Compra{
    ...
    public void generateTicket_compra(){
        ...
        String ruta = new String("C:\\Users\\sauce\\Desktop\\Universidad\\Cuarto\\Segundo semestre\\DSS\\Jungla\\Ticket" + n + ".txt");
        File f;
        ...
        try{
            try{
                do{
                    ...
                    if(f.exists()){
                        n++;
                        ruta = "C:\\Users\\sauce\\Desktop\\Universidad\\Cuarto\\Segundosemestre\\DSS\\Jungla\\Ticket" + n + ".txt";
                    }
                    else{
                        salida = true;
                    }
